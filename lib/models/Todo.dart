...
class Todo extends Model {
  ...
  const Todo._internal({required this.id, required name, description, required done, createdAt, updatedAt}): _name = name, _description = description, _done = done, _createdAt = createdAt, _updatedAt = updatedAt;
  
  factory Todo({String? id, required String name, String? description, required bool done}) {
